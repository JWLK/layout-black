...
import { ViewScale, ViewMargin, ViewSize } from '@Tools/AxisBase';
...
const Parts = ({ zero, draw }) => {
    var array = [];
    var partCurrent = 0;
    var partNext = 0;
    var partSum = elements[`sec-1`];
    for (var i = Object.keys(elements).length; i >= 1; i--) {
